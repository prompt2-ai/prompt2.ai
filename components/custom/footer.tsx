    ...
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
              <a href="https://prompt2.io/" className="flex items-center">
                  <Image src="/logo.svg" 
                  className="h-8 me-3" 
                  width={50} 
                  height={50} 
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://prompt2.io/" className="hover:underline">Prompt2</a>. All Rights Reserved.
          </span>
